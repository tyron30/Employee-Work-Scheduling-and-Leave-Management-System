...
<body>
    ...
    <div class="col-12 text-right">
        <a href="pending-report.php" target="_blank" class="btn btn-primary">
            <i class="fa fa-print"></i> Generate/Print Report
        </a>
    </div>
</div>
