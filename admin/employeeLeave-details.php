...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    // Handle editing existing action
    if (isset($_POST['updateAction'])) {
        ...
        if ($query->execute()) {
            $msg = "Leave action updated successfully.";
        } else {
            $error = "Failed to update leave action.";
        }
    }
    ...
    $sql = "SELECT tblleaves.id as lid, tblemployees.FirstName, tblemployees.LastName, 
                   tblemployees.EmpId, tblemployees.id, tblemployees.Gender, tblemployees.Phonenumber, 
                   tblemployees.EmailId, tblleaves.LeaveType, tblleaves.ToDate, tblleaves.FromDate, 
                   tblleaves.Description, tblleaves.PostingDate, tblleaves.Status, tblleaves.AdminRemark, 
                   tblleaves.AdminRemarkDate, tblleaves.ProofFile 
            FROM tblleaves 
                            ...
                            <div class="card-body">
                                ...
                                <div class="single-table">
                                    ...
                                    <tr>
                                            ...
                                            <td colspan="1"><?php echo date('m-d-Y', strtotime($result->FromDate)); ?></td>
                                            <td><b>Leave Upto:</b></td>
                                            <td colspan="1"><?php echo date('m-d-Y', strtotime($result->ToDate));?></td>
                                ...
                                <td><?php echo date('m-d-Y', strtotime($result->PostingDate));
?></td>
                                ...
                                <td ><b>Admin Action On: </b></td>
                                    ...
                                    echo "NA";  
                                        ...
                                        echo date('m-d-Y h:i A', strtotime($result->AdminRemarkDate));
    ...
    <td colspan="12">
        ...
        <!-- Set Action Button, visible only when status is pending -->
        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal" id="setActionBtn" style="display: <?php echo ($result->Status == 0) ? 'inline-block' : 'none'; ?>;">Set Action</button>
