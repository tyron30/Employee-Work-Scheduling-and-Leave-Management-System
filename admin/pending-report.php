...
$sql = "SELECT 
        ...
        WHERE tblleaves.Status = 0"; // Pending only
...
<head>
    <meta charset="UTF-8">
    <title>Pending Leave Report</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        ...
        <h3>Pending Employee Leave Report</h3>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="7">No pending leave requests found.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
