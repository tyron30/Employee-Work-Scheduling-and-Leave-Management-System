...
if(strlen($_SESSION['alogin']) == 0) {   
    ...
    if(isset($_POST['add'])){
        ...
        $age = $dob_date->diff($current_date)->y; // Calculate age in years
...
function generatePassword() {
    const length = 8; // Adjust password length if needed
...
<body>
    ...
    <div class="input-group">
        ...
        <div class="input-group-append">
            ...
            <button class="btn btn-light" type="button" onclick="togglePasswordVisibility('password', this)">
                <i class="fa fa-eye"></i>
            </button>
        </div>
    </div>
...
<div class="form-group">
    ...
    <div class="input-group">
        <input class="form-control" id="confirmpassword" name="confirmpassword" type="password" autocomplete="off" required>
        <div class="input-group-append">
            <button class="btn btn-light" type="button" onclick="togglePasswordVisibility('confirmpassword', this)">
                <i class="fa fa-eye"></i>
            </button>
        </div>
    </div>
