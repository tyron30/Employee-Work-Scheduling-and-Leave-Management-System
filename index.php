...
if(isset($_POST['signin']))
{
    ...
    // Updated SQL query to fetch EmpId instead of id
    $sql ="SELECT EmpId, EmailId, Password, Status, id FROM tblemployees WHERE EmailId=:uname and Password=:password";
    ...
    if($query->rowCount() > 0)
    {
        foreach ($results as $result) {
            ...
            $_SESSION['eid'] = $result->EmpId; // Set the session variable to EmpId instead of id
        ...
        if($status == 0)
        {
            ...
            echo "<script type='text/javascript'> document.location = 'employees/schedule.php'; </script>";
        }
    } else  {
                ...
                <div class="login-box ptb--100">
                    <form method="POST" name="signin">
                        <div class="login-form-head">
                            ...
                            <p>Employee Work Schedule and Leave Management System</p>
