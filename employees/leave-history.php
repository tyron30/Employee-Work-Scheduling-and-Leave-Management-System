...
<body>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                              <li class="#">
                                <a href="schedule.php" aria-expanded="true"><i class="ti-user"></i><span>Work Schedule
                                    </span></a>
                            </li>
    ...
    function validateLeaveDates() {
        ...
        // Check if end date is less than start date + 7 days
        var minEndDate = new Date(startDate);
        minEndDate.setDate(startDate.getDate() + 6); // Add 6 days (minimum 1 week)

        if (endDate < minEndDate) {
            alert('The end date must be at least one week after the start date.');
            return false; // prevent form submission
        }

        // Check if start date is the same as end date
        if (startDate.toDateString() === endDate.toDateString()) {
            alert('The start date and end date cannot be the same.');
            return false; // prevent form submission
        }
